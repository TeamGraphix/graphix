...
CLIFFORD = [
    ...
    _C13, _C14, _C15, _C16, _C17, _C18, _C19, _C20, _C21, _C22, _C23]

# readable labels for the 1-qubit Clifford
CLIFFORD_LABEL = [
    "I", "X", "Y", "Z", "S", "Sdagger", "H", r"\sqrt{iX}", r"\sqrt{iY}",
    r"\sqrt{I}", r"\sqrt{-I}", r"\sqrt{I}", r"\sqrt{-iY}", r"\sqrt{-I}",
    r"\sqrt{-I}", r"\sqrt{-iX}", "I^{1/3}", "I^{1/3}", "I^{1/3}",
...
CLIFFORD_CONJ = np.array(
    [0, 1, 2, 3, 5, 4, 6, 15, 12, 9, 10, 11, 8, 13, 14, 7, 20,
        22, 23, 21, 16, 19, 17, 18], dtype=np.int32)
...
CLIFFORD_MEASURE = [
    [(0, 0), (1, 0), (2, 0)], [(0, 0), (1, 1), (2, 1)], [(0, 1), (1, 0), (2, 1)],
    [(0, 1), (1, 1), (2, 0)], [(1, 1), (0, 0), (2, 0)], [(1, 0), (0, 1), (2, 0)],
    [(2, 0), (1, 1), (0, 0)], [(0, 0), (2, 1), (1, 0)], [(2, 0), (1, 0), (0, 1)],
    [(1, 1), (0, 1), (2, 1)], [(1, 0), (0, 0), (2, 1)], [(2, 1), (1, 1), (0, 1)],
    [(2, 1), (1, 0), (0, 0)], [(0, 1), (2, 1), (1, 1)], [(0, 1), (2, 0), (1, 0)],
    [(0, 0), (2, 0), (1, 1)], [(2, 0), (0, 0), (1, 0)], [(2, 1), (0, 0), (1, 1)],
    [(2, 1), (0, 1), (1, 0)], [(2, 0), (0, 1), (1, 1)], [(1, 0), (2, 0), (0, 0)],
    [(1, 1), (2, 1), (0, 0)], [(1, 0), (2, 1), (0, 1)], [(1, 1), (2, 0), (0, 1)]]

# OpenQASM3 representation of Clifford gates above.
CLIFFORD_TO_QASM3 = [
    ['id'], ['x'], ['y'], ['z'],
    ['s'], ['sdg'], ['h'], ['sdg','h','sdg'],
    ['h','x'], ['sdg','y'], ['sdg','x'], ['h','y'], ['h','z'],
    ['sdg','h','sdg','y'], ['sdg','h','s'], ['sdg','h','sdg','x'],
    ['sdg','h'], ['sdg','h','y'], ['sdg','h','z'], ['sdg','h','x'],
    ['h','s'], ['h','sdg'], ['h','x','sdg'], ['h','x','s']]
