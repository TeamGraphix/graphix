...
class Pattern:
    ...
    def to_ascii(
        ...
        >>> pattern.to_ascii()
        'X(24,{21}) Z(24,{20}) X(32,{31}) Z(32,{28}) X(30,{29}) Z(30,{0}) {27}[M(31)]{28} E(31,32) N(32) [M(29)]{0} E(29,30) N(30) {26}[M(28,-Y)]{27} E(28,31) N(31) {17}[M(21)]{20} E(21,24) N(24) {25}[M(27)]{26} E(27,28) N(28) {26,19,15,7}[M(0,7pi/4)] E(0,27) E(0,29) N(29) {16}[M(20)]{17} E(20,21) N(21) {23}[M(26)]{25} E(26,27) N(27) {22}[M(25)]{23} E(25,26) N(26) {15}[M(17,7pi/4)]{16} E(17,20) N(20) {19}[M(23,pi/4)]{22} E(23,25)...(63 more commands)'
        >>> pattern.to_ascii(left_to_right=True)
        'N(3) E(2,3) M(2) N(4) E(3,4) [M(3)]{2} E(4,1) N(5) E(4,5) {2}[M(4)]{3} N(6) E(5,6) {3}[M(5,pi/4)]{4} N(7) E(6,7) {4}[M(6)]{5} N(8) E(7,8) {5}[M(7)]{6} E(8,0) N(9) E(8,9) {6}[M(8)]{7} N(10) E(9,10) {7}[M(9,7pi/4)]{8} N(11) E(10,11) {8}[M(10)]{9} N(12) E(11,12) {9}[M(11)]{10} N(18) E(1,18) E(1,12) {11,3}[M(1,pi/4)] N(13) E(12,13) {10}[M(12)]{11}...(63 more commands)'
        >>> pattern.to_ascii(limit=None)
        'X(24,{21}) Z(24,{20}) X(32,{31}) Z(32,{28}) X(30,{29}) Z(30,{0}) {27}[M(31)]{28} E(31,32) N(32) [M(29)]{0} E(29,30) N(30) {26}[M(28,-Y)]{27} E(28,31) N(31) {17}[M(21)]{20} E(21,24) N(24) {25}[M(27)]{26} E(27,28) N(28) {26,19,15,7}[M(0,7pi/4)] E(0,27) E(0,29) N(29) {16}[M(20)]{17} E(20,21) N(21) {23}[M(26)]{25} E(26,27) N(27) {22}[M(25)]{23} E(25,26) N(26) {15}[M(17,7pi/4)]{16} E(17,20) N(20) {19}[M(23,pi/4)]{22} E(23,25) N(25) {14}[M(16)]{15} E(16,0) E(16,17) N(17) {13}[M(15)]{14} E(15,16) N(16) {18}[M(22)]{19} E(22,23) N(23) E(22,0) {12}[M(14)]{13} E(14,15) N(15) {1}[M(19)]{18} E(19,22) N(22) {11}[M(13,pi/4)]{12} E(13,14) N(14) [M(18)]{1} E(18,19) N(19) {10}[M(12)]{11} E(12,13) N(13) {11,3}[M(1,pi/4)] E(1,12) E(1,18) N(18) {9}[M(11)]{10} E(11,12) N(12) {8}[M(10)]{9} E(10,11) N(11) {7}[M(9,7pi/4)]{8} E(9,10) N(10) {6}[M(8)]{7} E(8,9) N(9) E(8,0) {5}[M(7)]{6} E(7,8) N(8) {4}[M(6)]{5} E(6,7) N(7) {3}[M(5,pi/4)]{4} E(5,6) N(6) {2}[M(4)]{3} E(4,5) N(5) E(4,1) [M(3)]{2} E(3,4) N(4) M(2) E(2,3) N(3)'
        >>> from graphix.command import CommandKind
        >>> pattern.to_ascii(target={CommandKind.M})
        '{27}[M(31)]{28} [M(29)]{0} {26}[M(28,-Y)]{27} {17}[M(21)]{20} {25}[M(27)]{26} {26,19,15,7}[M(0,7pi/4)] {16}[M(20)]{17} {23}[M(26)]{25} {22}[M(25)]{23} {15}[M(17,7pi/4)]{16} {19}[M(23,pi/4)]{22} {14}[M(16)]{15} {13}[M(15)]{14} {18}[M(22)]{19} {12}[M(14)]{13} {1}[M(19)]{18} {11}[M(13,pi/4)]{12} [M(18)]{1} {10}[M(12)]{11} {11,3}[M(1,pi/4)] {9}[M(11)]{10} {8}[M(10)]{9} {7}[M(9,7pi/4)]{8} {6}[M(8)]{7} {5}[M(7)]{6} {4}[M(6)]{5} {3}[M(5,pi/4)]{4} {2}[M(4)]{3} [M(3)]{2} M(2)'
    ...
    def to_latex(
        ...
        '\\({}_{27}[M_{31}]^{28}\\,[M_{29}]^{0}\\,{}_{26}[M_{28}^{-Y}]^{27}\\,{}_{17}[M_{21}]^{20}\\,{}_{25}[M_{27}]^{26}\\,{}_{26,19,15,7}[M_{0}^{\\frac{7\\pi}{4}}]\\,{}_{16}[M_{20}]^{17}\\,{}_{23}[M_{26}]^{25}\\,{}_{22}[M_{25}]^{23}\\,{}_{15}[M_{17}^{\\frac{7\\pi}{4}}]^{16}\\,{}_{19}[M_{23}^{\\frac{\\pi}{4}}]^{22}\\,{}_{14}[M_{16}]^{15}\\,{}_{13}[M_{15}]^{14}\\,{}_{18}[M_{22}]^{19}\\,{}_{12}[M_{14}]^{13}\\,{}_{1}[M_{19}]^{18}\\,{}_{11}[M_{13}^{\\frac{\\pi}{4}}]^{12}\\,[M_{18}]^{1}\\,{}_{10}[M_{12}]^{11}\\,{}_{11,3}[M_{1}^{\\frac{\\pi}{4}}]\\,{}_{9}[M_{11}]^{10}\\,{}_{8}[M_{10}]^{9}\\,{}_{7}[M_{9}^{\\frac{7\\pi}{4}}]^{8}\\,{}_{6}[M_{8}]^{7}\\,{}_{5}[M_{7}]^{6}\\,{}_{4}[M_{6}]^{5}\\,{}_{3}[M_{5}^{\\frac{\\pi}{4}}]^{4}\\,{}_{2}[M_{4}]^{3}\\,[M_{3}]^{2}\\,M_{2}\\)'
    ...
    def to_unicode(
        ...
        >>> pattern = circuit.transpile().pattern
        >>> pattern.to_unicode()
        'X₂₄²¹ Z₂₄²⁰ X₃₂³¹ Z₃₂²⁸ X₃₀²⁹ Z₃₀⁰ ₂₇[M₃₁]²⁸ E₃₁₋₃₂ N₃₂ [M₂₉]⁰ E₂₉₋₃₀ N₃₀ ₂₆[M₂₈(-Y)]²⁷ E₂₈₋₃₁ N₃₁ ₁₇[M₂₁]²⁰ E₂₁₋₂₄ N₂₄ ₂₅[M₂₇]²⁶ E₂₇₋₂₈ N₂₈ ₂₆₊₁₉₊₁₅₊₇[M₀(7π/4)] E₀₋₂₇ E₀₋₂₉ N₂₉ ₁₆[M₂₀]¹⁷ E₂₀₋₂₁ N₂₁ ₂₃[M₂₆]²⁵ E₂₆₋₂₇ N₂₇ ₂₂[M₂₅]²³ E₂₅₋₂₆ N₂₆ ₁₅[M₁₇(7π/4)]¹⁶ E₁₇₋₂₀ N₂₀ ₁₉[M₂₃(π/4)]²² E₂₃₋₂₅...(63 more commands)'
        >>> pattern.to_unicode(left_to_right=True)
        'N₃ E₂₋₃ M₂ N₄ E₃₋₄ [M₃]² E₄₋₁ N₅ E₄₋₅ ₂[M₄]³ N₆ E₅₋₆ ₃[M₅(π/4)]⁴ N₇ E₆₋₇ ₄[M₆]⁵ N₈ E₇₋₈ ₅[M₇]⁶ E₈₋₀ N₉ E₈₋₉ ₆[M₈]⁷ N₁₀ E₉₋₁₀ ₇[M₉(7π/4)]⁸ N₁₁ E₁₀₋₁₁ ₈[M₁₀]⁹ N₁₂ E₁₁₋₁₂ ₉[M₁₁]¹⁰ N₁₈ E₁₋₁₈ E₁₋₁₂ ₁₁₊₃[M₁(π/4)] N₁₃ E₁₂₋₁₃ ₁₀[M₁₂]¹¹...(63 more commands)'
        >>> from graphix.command import CommandKind
        >>> pattern.to_unicode(target={CommandKind.M})
        '₂₇[M₃₁]²⁸ [M₂₉]⁰ ₂₆[M₂₈(-Y)]²⁷ ₁₇[M₂₁]²⁰ ₂₅[M₂₇]²⁶ ₂₆₊₁₉₊₁₅₊₇[M₀(7π/4)] ₁₆[M₂₀]¹⁷ ₂₃[M₂₆]²⁵ ₂₂[M₂₅]²³ ₁₅[M₁₇(7π/4)]¹⁶ ₁₉[M₂₃(π/4)]²² ₁₄[M₁₆]¹⁵ ₁₃[M₁₅]¹⁴ ₁₈[M₂₂]¹⁹ ₁₂[M₁₄]¹³ ₁[M₁₉]¹⁸ ₁₁[M₁₃(π/4)]¹² [M₁₈]¹ ₁₀[M₁₂]¹¹ ₁₁₊₃[M₁(π/4)] ₉[M₁₁]¹⁰ ₈[M₁₀]⁹ ₇[M₉(7π/4)]⁸ ₆[M₈]⁷ ₅[M₇]⁶ ₄[M₆]⁵ ₃[M₅(π/4)]⁴ ₂[M₄]³ [M₃]² M₂'
