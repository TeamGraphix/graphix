...
class GraphVisualizer:
    ...
    def visualize(
        ...
        if causal_flow is not None:
            ...
            pos = self.get_pos_from_causal_flow(causal_flow)
    ...
    def visualize_from_pattern(
        ...
        try:
            ...
            try:
                ...
                print("The pattern is consistent with gflow structure (but not with causal flow).")
                pos = self.get_pos_from_pauli_flow(g_flow)
    ...
    def get_pos_from_causal_flow(self, flow: CausalFlow[AbstractPlanarMeasurement]) -> dict[int, _Point]:
        """
    ...
    def get_pos_from_pauli_flow(self, flow: PauliFlow[AbstractMeasurement]) -> dict[int, _Point]:
        """
