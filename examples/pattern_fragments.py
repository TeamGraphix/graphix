...
# %%
# First, for Toffoli gate, here is the pattern based on the decomposition of CCX gate
# with CNOT and single-qubit rotations, turned into a measurement pattern:
import numpy as np
...
# %%
# Using :code:`opt=True` option for :code:`transpile` method,
# we switch to patterns with non-XY plane measurements allowed,
...
# %%
# For linear optical QPUs with single photons,
# such a resource state can be generated by fusing the follwoing microcluster states:
