...
class TestExtraction(unittest.TestCase):
    ...
    def test_cluster_extraction_one_ghz_cluster(self):
        ...
        self.assertEqual(
            clusters[0]
            == extraction.ResourceGraph(type=extraction.ResourceType.GHZ, graph=gs),
            True,
        )
    ...
    def test_cluster_extraction_one_linear_cluster(self):
        ...
        self.assertEqual(
            clusters[0]
            == extraction.ResourceGraph(type=extraction.ResourceType.LINEAR, graph=gs),
            True,
        )
    ...
    def test_cluster_extraction_one_ghz_one_linear(self):
        ...
        clusters_expected.append(
            extraction.ResourceGraph(extraction.ResourceType.LINEAR, lin_cluster)
        )
        ...
        clusters_expected.append(
            extraction.ResourceGraph(extraction.ResourceType.GHZ, ghz_cluster)
        )
        ...
        self.assertEqual(
            ...
            or (
                clusters[0] == clusters_expected[1]
    ...
    def test_cluster_extraction_pentagonal_cluster(self):
        ...
        self.assertEqual(
            ...
            or (
                clusters[0].type == extraction.ResourceType.LINEAR
