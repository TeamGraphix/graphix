...
def compare_backend_result_with_statevec(backend_state: Statevec | DensityMatrix, statevec: Statevec) -> bool:
...
class TestPattern:
    ...
    def test_pauli_measurement_random_circuit(
        ...
        assert compare_backend_result_with_statevec(state_mbqc, state)
    ...
    def test_pauli_measurement_then_standardize(self, fx_bg: PCG64, jumps: int) -> None:
        ...
        assert compare_backend_result_with_statevec(state_mbqc, state_ref)
